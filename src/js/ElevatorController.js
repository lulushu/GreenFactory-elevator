...
ElevatorController.prototype = {
    ...
    _cacheEventHandlers: function () {
        ...
        this._eventHandlers._onFindExistElevator = $.proxy(this._onFindExistElevator, this);
    },

    _assignEvent: function () {
        this._$Collection.on("findElevator", this._eventHandlers._onFindElevator);
        this._$Collection.on("alreadyArriveElevator", this._eventHandlers._onFindExistElevator);
    ...
    _onFindExistElevator: function (event) {
        this._oView.activateElevator2(event.floor);
    },
